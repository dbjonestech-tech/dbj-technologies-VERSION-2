    ...
    <article className="relative pt-40 pb-20">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="prose-invert space-y-8 text-text-secondary text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">2. Services</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">3. Intellectual Property</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">4. Client Responsibilities</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">5. Payment Terms</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">6. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">7. Termination</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-3">8. Governing Law</h2>
