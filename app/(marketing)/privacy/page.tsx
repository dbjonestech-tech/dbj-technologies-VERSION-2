      ...
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        ...
        <div className="space-y-8 text-text-secondary text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>This website uses essential cookies required for site functionality, two first-party analytics cookies (a visitor identifier and a session identifier, described in the Analytics section), and optional third-party analytics cookies set by Google Analytics when you accept the cookie banner. No third-party advertising cookies are used.</p>
          </section>

          <section>
            <h2 className="font-display text-lg font-bold text-gray-900 mb-3">5. Analytics</h2>
            <p>This site uses two layers of analytics. The first is in-house, first-party measurement that records page views, sessions, traffic sources, approximate geographic region, device type, and Core Web Vitals. Two first-party cookies support this: a visitor identifier (lifespan approximately 13 months) and a session identifier (idle 30-minute window). IP addresses are never stored in raw form. They are hashed at the moment of collection using a daily-rotated salt and discarded immediately afterward; only the hash and the country/region/city derived from the request are persisted. Raw page-view rows are retained for 90 days; aggregated session data is retained for 13 months.</p>
            <p className="mt-3">The second layer is Google Analytics, which loads only when you accept the cookie banner. Google Analytics uses cookies to collect anonymous usage data, and IP addresses are anonymized before they reach Google. No personally identifiable information is shared with Google. You can opt out of Google Analytics by clicking Decline on the cookie banner, by clearing the consent value from your browser storage, or by installing Google&apos;s official opt-out browser add-on at <a href="https://tools.google.com/dlpage/gaoptout" className="text-accent-blue hover:underline" rel="noopener noreferrer" target="_blank">tools.google.com/dlpage/gaoptout</a>. I also use Vercel Speed Insights, which is a separate, cookieless performance measurement tool that records anonymous page load timings without tracking individuals.</p>
          </section>
