...
export const PRICING_DETAILS: PricingDetail[] = [
  {
    ...
    faq: [
      ...
      { question: "Can I upgrade to Scale later?", answer: "Absolutely. Every Foundation engagement is built on the same modern architecture as Scale and Enterprise phases. Adding pages, CMS, or advanced features later is straightforward — no rewrites needed." },
  ...
  },
  {
    ...
    idealFor: [
      ...
      "Teams that need priority support and faster iteration cycles",
    ],
    whatsIncluded: [
      ...
      { title: "Headless CMS Integration", description: "Full content management system so your team can update pages, blog posts, and media without developer help." },
      ...
      { title: "Collaborative Design Review Cycles", description: "Multiple collaborative review cycles to ensure every detail meets your standards — not arbitrary 'revision rounds.'" },
    ...
    faq: [
      { question: "Why is Scale the most common engagement?", answer: "It hits the sweet spot for most businesses — enough pages for a comprehensive site, CMS so your team stays independent, custom animations that make a strong impression, and priority support for peace of mind." },
      { question: "What CMS do you recommend?", answer: "For most Scale engagements, I recommend Sanity for its flexibility and developer experience. I also work with Strapi, Contentful, and headless WordPress depending on your team's needs." },
  ...
  },
  {
    ...
    idealFor: [
      ...
      "Teams that need dedicated architectural oversight throughout the engagement",
    ],
    whatsIncluded: [
    ...
    timeline: "8–20 weeks depending on scope (defined during paid discovery)",
