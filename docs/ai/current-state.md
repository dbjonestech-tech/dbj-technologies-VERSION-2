...
- About page: dark hero section, split layout with joshua-jones.webp (radial-gradient ellipse mask, not a hard rounded rectangle), clip-path reveal animation, floating geometric accents, character-level headline animation, story sections ("Why I Work This Way", "What You Actually Get", "How I Build", "Who This Is For"), personal sign-off, gradient divider, values cards with hover glow
