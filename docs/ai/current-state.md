...
- Homepage: HeroCinema phase-based animation (blueprint -> build -> reveal -> complete), "Architect The Impossible." headline with period
- About page: dark hero section, split layout with joshua-jones.webp (true alpha-channel transparent PNG sourced through cwebp -q 90 -alpha_q 100; subject silhouette floats directly over the dark page bg, no maskImage applied — the previous radial-gradient ellipse mask was removed because it was trimming the silhouette mid-torso once the PNG had genuine alpha), clip-path reveal animation, floating geometric accents, character-level headline animation, story sections ("Why I Work This Way", "What You Actually Get", "How I Build", "Who This Is For"), personal sign-off, gradient divider, values cards with hover glow
...
- Pricing: Starter $4,500, Professional $9,500, Enterprise custom (price: null, scoped during paid discovery). Maintenance $299/month. Hourly consulting $175/hour.
